...
const RestArea = ({ handleSubmit }) => {
  ...
  return (
    <>
      <form onSubmit={(e) => handleSubmit(e, regionSelect, areaTypeSelect)}>
        ...
        <div className="select-outter-container">
          ...
          <p>
            Select the region as well as the area type of your choice from the
            dropdown menus, to search and generate data that matches!
          </p>
        </div>
      </form>
    </>
